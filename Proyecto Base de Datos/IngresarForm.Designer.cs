...
comboBoxTipoServicioTipo = new ComboBox();
...
textBoxPeso.PlaceholderText = "Ej: 2.5";
 ...
 lblProveedor.TabIndex = 22;
  ...
  comboBoxProveedor.Location = new Point(340, 317);
            comboBoxProveedor.Name = "comboBoxProveedor";
            comboBoxProveedor.Size = new Size(200, 23);
...
// 
       // comboBoxTipoServicioTipo
       // 
     comboBoxTipoServicioTipo.DropDownStyle = ComboBoxStyle.DropDownList;
     comboBoxTipoServicioTipo.FormattingEnabled = true;
     comboBoxTipoServicioTipo.Items.AddRange(new object[] { "Servicio", "Bien" });
     comboBoxTipoServicioTipo.Location = new Point(340, 347);
          comboBoxTipoServicioTipo.Name = "comboBoxTipoServicioTipo";
  comboBoxTipoServicioTipo.Size = new Size(120, 23);
      comboBoxTipoServicioTipo.TabIndex = 25;
       // 
     // labelCategoria
  // 
  ...
  labelCategoria.Name = "labelCategoria";
   ...
   comboBoxCategoria.Location = new Point(340, 377);
     comboBoxCategoria.Name = "comboBoxCategoria";
        comboBoxCategoria.Size = new Size(150, 23);
 comboBoxCategoria.TabIndex = 27;
            // 
         // labelStock
      // 
...
Controls.Add(textBoxStock);
   Controls.Add(labelStock);
      ...
      Controls.Add(comboBoxTipoServicioTipo);
...
private Label lblProveedor;
  ...
  private ComboBox comboBoxTipoServicioTipo;
